    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="{{ asset('assets') }}/img/logo.png" alt="" style="margin-right: 20px;">
                <span>TIE</span>
            </a>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="mahasiswa.html">Mahasiswa</a></li>
    ...
    <footer id="footer" class="footer">
        <div class="container">
            <div class="copyright">
                ...
                </script> Copyright <strong><span>TIE</span></strong>. All
                Rights Reserved
            </div>
        </div>
    </footer><!-- End Footer -->
